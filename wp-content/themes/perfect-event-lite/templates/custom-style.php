<?php 
/**
 * The Custom Style for Perfect Event Lite
 *
...
/*-----------------------------COLORS------------------------------------*/
		...
		.page .header, .single .header, .archive .header, .search .header, .error404 .header{ position:relative!important; background-color: rgba(<?php echo complete_hex2rgb($complete['head_color_id']);?>, 1)!important;}
		...
		/*Head Top Bar Color*/
		.head-info-area{background-color: rgba(<?php echo complete_hex2rgb($complete['head_info_color_id']);?>, <?php if(empty($complete['head_transparent'])){ echo '1'; }else { echo $complete['head_bg_trans'];} ?>);}
	
.head-info-area, .head-info-area .social-icons a, .head-info-area .social-icons a:first-child{ border-color:<?php echo $complete['head_bd_color_id']; ?>;}

body.has_trans_header.not_frontpage .head-info-area{position:relative!important; background-color:rgba(<?php echo complete_hex2rgb($complete['head_info_color_id']);?>, 1)!important;}
		...
		<?php } ?>
		body.has_trans_header.not_frontpage .header{background:<?php echo $complete['head_color_id']; ?>!important;}
		...
		<?php if(!empty($complete['logo_first_color_id'])){ ?>
			.logo h1 span, .logo h2 span{color:<?php echo $complete['logo_first_color_id']; ?>;}
		<?php } ?>
...
/* Event Counter border Color */
		.counter-column{ 
			border-color:<?php echo $complete['event_box_bd_color']; ?>;
			color:<?php echo $complete['event_box_text_color']; ?>;
		}
		...
		.column-event{ 
			background-color:<?php echo $complete['event_box_color_id']; ?>;
			color:<?php echo $complete['eventdes_box_color_id']; ?>;
		}
		
		 .date-events{
			background-color:<?php echo $complete['event_box_color_id']; ?>;
			color:<?php echo $complete['eventdate_color']; ?>;
		}
		
		
		.column-event h5 span.spaneventbd{ 
			border-color:<?php echo $complete['eventtitlebd_color']; ?>;
		}
		...
		.testimonial-box{ 
			border-color:<?php echo $complete['testimonialbox_color_id']; ?>;
		}	
		...
		#topmenu .menu_hover > a:link, #topmenu .menu_hover > a:visited, #topmenu ul li.current-menu-item>a:link, #topmenu ul li.current-menu-item> a:visited, #topmenu ul li.current-menu-parent>a:link, #topmenu ul li.current_page_parent>a:visited, #topmenu ul li.current-menu-ancestor>a:link, #topmenu ul li.current-menu-ancestor>a:visited{	border-bottom-color:<?php echo $complete['mnbg_color_id']; ?> !important;}
...
/*Widget Title Color */
#sidebar .widget-title, #sidebar .widget-title a, #sidebar .widgettitle, #sidebar .widgettitle a{color:<?php echo $complete['sidebar_tt_color_id'] ?>;}
...
#footer .footercols1 h5, #footer .footercols2 h5, #footer .footercols3 h5, #footer .footercols4 h5{color:<?php echo $complete['footer_title_color']; ?>;}
<?php } ?>

<?php if((!empty($complete['footer_title_bd_color']))){ ?>
#footer .footercols1 h5::after, #footer .footercols2 h5::after, #footer .footercols3 h5::after, #footer .footercols4 h5::after{border-color:<?php echo $complete['footer_title_bd_color']; ?>;}
<?php } ?>

#footer .contact-info{background:<?php echo $complete['footer_info_bgcolor']; ?>;}
#copyright .center{border-color:<?php echo $complete['footer_info_bgcolor']; ?>;}
...
#footer .footercols1, #footer .footercols2, #footer .footercols3, #footer .footercols4, .footer-post-area ul li h4, .footer-post-area ul li h4 a:link, .footer-post-area ul li h4 a:visited, .footmenu li a, .footer-post-area ul li a{color:<?php echo $complete['footwdgtxt_color_id']; ?> !important;}
<?php } ?>
/*COPYRIGHT COLORS*/
